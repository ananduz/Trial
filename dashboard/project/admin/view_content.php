...
<section class="view-content">
   ...
   <div class="container">
      ...
      <iframe src="../uploaded_files/<?= $fetch_content['document']; ?>" style="width:100%; height:600px;"></iframe>
      <div class="description"><?= $fetch_content['description']; ?></div>
      <form action="" method="post">
         <div class="flex-btn">
            <input type="hidden" name="document_id" value="<?= $document_id; ?>">
            <input type="submit" value="delete document" name="delete_document" class="delete-btn" onclick="return confirm('delete this document?');">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">No documents added yet! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Add documents</a></p>';
   }
